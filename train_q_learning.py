...
class QLearningAgent:
    def __init__(self, action_size, alpha=0.1, gamma=0.9, epsilon=1.0, epsilon_decay=0.9995, min_epsilon=0.1):
...
def train_agent(num_episodes=100000, max_steps=500):
    ...
    for episode in range(num_episodes):
        ...
        if episode % 1000 == 0:
            print(f"Episode {episode}: Grid Size = {grid_size}x{grid_size}, Reward = {total_reward}, Epsilon = {agent.epsilon:.4f}")
